...
class ANNModel(object):
    ...
    def __init__(self, x_train, y_train):
        ...
        self.model.add(Dense(units=64, activation='relu', input_shape=(x_train.shape[1],)))
        self.model.add(Dropout(0.2))
        self.model.add(Dense(units=32, activation='relu', kernel_regularizer=regularizers.l2(0.02)))
        self.model.add(Dropout(0.2))
